...
class DASHBOARD:
    ...
    def __init__(self, TDU_LIST):
        ...
        # with st.echo(code_location='below'):
            ...
            st.write(self.weekly_performance_df.head())
    ...
    def read_weekly_performance_df(self, start_day, end_day):
        ...
        weekly_performance_query = f"SELECT * FROM {self.tdu_select}.PUBLIC.PERFORMANCE_REPORT WHERE DATE BETWEEN '{start_day}' AND '{end_day}'" ##SET THE START DATE
        index = 0
